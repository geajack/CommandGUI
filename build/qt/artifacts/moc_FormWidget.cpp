...
QT_MOC_LITERAL(1, 11, 11), // "formChanged"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "FormWidget\0formChanged\0"
};
...
void FormWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FormWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->formChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FormWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FormWidget::formChanged)) {
                *result = 0;
                return;
            }
        }
